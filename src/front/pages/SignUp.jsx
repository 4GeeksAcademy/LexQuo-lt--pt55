...
export default function SignUp() {
  ...
  const [currentStep, setCurrentStep] = useState(1); // 1: datos básicos, 2: contacto/seguridad
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!resp.ok) {
        throw new Error(
          data?.error || data?.msg || "The user could not be created."
        );
      }
            ...
            <div className="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3 p-4">
              <Link className="d-flex flex-center text-decoration-none mb-4" to="/">
                <div className="d-flex align-items-center fw-bolder fs-3 d-inline-block">
                  <img
                    src="https://res.cloudinary.com/doxdmmj1o/image/upload/v1759017461/LogoLexQuoN_hhfcks.png"
                    alt="LexQuo"
                    width="240"
                  />
                </div>
              ...
              <form onSubmit={handleSubmit}>
                {/* ====== PASO 1: nombre, apellido, mail y rol ====== */}
                {currentStep === 1 && (
                  <>
                  ...
                  <>
                    ...
                    <div className="mb-3 text-start">
                      ...
                      <div className="position-relative" data-password="data-password">
                        ...
                        <button
                          type="button"
                          className="btn px-3 py-0 h-100 position-absolute top-0 end-0 fs-8 text-body-tertiary"
                          onClick={() => setShowPwd((v) => !v)}
                          data-password-toggle="data-password-toggle"
                        >
                          <span className={showPwd ? "bi bi-eye-slash" : "bi bi-eye"}></span>
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="mb-4 text-start">
                      ...
                      <div className="position-relative" data-password="data-password">
                        ...
                        <button
                          ...
                          data-password-toggle="data-password-toggle"
                        >
                          <span className={showConfirm ? "bi bi-eye-slash" : "bi bi-eye"}></span>
                        </button>
                      </div>
                    </div>
