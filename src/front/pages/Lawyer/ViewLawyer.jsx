  ...
  return (
    <AppNavsShell>
      <div className="container-fluid px-0 px-md-3">
        ...
        {/* Header + acciones al ancho de la card */}
        <div className="col-7">
          <div className="d-flex flex-wrap align-items-center justify-content-between g-3 mb-4">
              ...
              {(role === "admin_user" || isMyProfile) && (
                <>
                  ...
                  <Link
                    ...
                    state={{ returnTo }}
                    className="btn btn-phoenix-warning btn-sm"
                  >
