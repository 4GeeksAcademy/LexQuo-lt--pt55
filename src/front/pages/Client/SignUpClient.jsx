...
export const SignUpClient = () => {
    ...
    return (
        <div className="container mt-5">
            <h2 className="mb-5">Create Client Account</h2>
            ...
            <div className="d-flex justify-content-end mt-5">
                <Link to="/LoginClient" className="btn btn-sm btn-outline-primary" style={{ border: "none" }}>Already have an account? Sign in!</Link>  {/* 👈 Enlace a LoginClient */}
            </div>
        </div>
    );
};